...
export const GoogleLoginButton: React.FC<GoogleLoginButtonProps> = ({
  ...
  const googleClientId =
    import.meta.env.VITE_GOOGLE_CLIENT_ID || '1234567890-testgoogleclientid.apps.googleusercontent.com';
  ...
  return (
    <div className="w-full space-y-2">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full bg-white text-slate-700 hover:bg-slate-50 border-slate-300 font-semibold text-xs flex items-center justify-center gap-2 cursor-pointer"
