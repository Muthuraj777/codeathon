  ...
  return (
    <Card className="bg-slate-900/80 backdrop-blur-xl border-slate-800 shadow-2xl">
      <CardHeader className="flex flex-row items-center justify-between pb-4 border-b border-slate-800/60">
        ...
        <Badge variant="outline" className="text-[10px] font-mono-code bg-slate-900/90 text-indigo-400 border-indigo-500/30 flex items-center gap-1">
          ...
          <div key={skill.skillName} className="space-y-2.5 group">
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 font-mono-code px-2 py-0.5 rounded-full bg-slate-800/80 border border-slate-700/60">
                  {skill.category}
                </span>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-[11px] font-medium text-slate-400">{skill.gapCount} Candidates Missing</span>
                <span className="font-mono-code text-xs font-bold text-indigo-300 bg-indigo-500/10 border border-indigo-500/30 px-2 py-0.5 rounded-md shadow-xs">
                  {skill.percentage}%
                </span>
              </div>
            </div>
