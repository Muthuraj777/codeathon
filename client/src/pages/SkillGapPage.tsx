    ...
    <div className="space-y-8 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <Button
          ...
          onClick={() => runAnalysis()}
          isLoading={isLoading}
          className="gap-2 shrink-0 border-slate-800 bg-slate-900/60"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 sm:p-8 bg-slate-900/70 rounded-3xl border border-slate-800/80 backdrop-blur-xl shadow-2xl">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-slate-950/80 border border-slate-800 rounded-2xl text-xs sm:text-sm font-semibold text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition cursor-pointer"
          >
            {students.map((s) => (
      ...
      {analysisResult && (
        <>
          ...
          {/* Action Bar */}
          <div className="flex flex-col sm:flex-row items-center justify-end gap-3 p-6 bg-slate-900/70 rounded-3xl border border-slate-800/80 backdrop-blur-xl shadow-xl">
            <Button variant="outline" size="md" className="w-full sm:w-auto gap-2 border-slate-800">
