...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#070a13] text-slate-100 relative overflow-hidden px-4 py-12">
      {/* Background Glows */}
      ...
      <div className="w-full max-w-lg space-y-6 relative z-10 animate-fade-in">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center p-3.5 rounded-2xl bg-gradient-to-tr from-indigo-600 to-violet-600 text-white shadow-xl shadow-indigo-600/30 border border-white/20 mb-1">
          ...
          <p className="text-sm text-slate-400 max-w-sm mx-auto">
            Join the Skill Gap Analyzer Platform &amp; unlock AI-driven competency trajectory insights.
          </p>
        </div>

        <Card className="border-slate-800/80 bg-slate-900/80 backdrop-blur-2xl shadow-2xl rounded-3xl overflow-hidden">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl text-white font-bold">Register Account</CardTitle>
            <CardDescription className="text-slate-400 text-xs">
              Select your organization role and fill in your account credentials
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-mono-code tracking-widest">
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`relative flex flex-col items-center justify-center p-3.5 rounded-2xl border text-xs font-bold transition-all duration-200 cursor-pointer ${
                          isSelected
                      ...
                      >
                        {isSelected && (
                          <CheckCircle className="w-3.5 h-3.5 text-indigo-400 absolute top-2.5 right-2.5" />
                        )}
          ...
          <CardFooter className="justify-center border-t border-slate-800/80 py-4 bg-slate-950/40">
